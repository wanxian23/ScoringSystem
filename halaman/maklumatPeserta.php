<?php 
	...
	$noKP = $_SESSION['noKP1']; // SESSION is used to connect variables from other php file

	$arahanSQL4 = "Select * from peserta where kad_KPpeserta = '$noKP';";
	$arahanSQL = "Select * from peserta inner join robot on peserta.idPeserta = robot.idPeserta where peserta.kad_KPpeserta = '$noKP';";
	$arahanSQL2 = "Select * from markah inner join peserta on markah.idPeserta = peserta.idPeserta where peserta.kad_KPpeserta = '$noKP' AND idJenis = 'IT01';";
	$arahanSQL3 = "Select * from markah inner join peserta on markah.idPeserta = peserta.idPeserta where kad_KPpeserta = '$noKP' AND idJenis = 'IT02';";
